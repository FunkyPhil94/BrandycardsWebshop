...
export default function DatenschutzPage() {
  return <main className="account-page">
    ...
    <article className="account-card legal-page">
      ...
      <h2>7. eBay-Synchronisierung und Kartenbilder</h2>
      ...
      <p><strong>Kartenbilder werden nicht von uns ausgeliefert, sondern direkt von den Bildservern von eBay geladen.</strong> Beim Aufruf einer Seite mit Kartenbildern stellt Ihr Browser deshalb eine Verbindung zu eBay her; dabei werden Ihre IP-Adresse und technische Angaben wie der verwendete Browser an eBay übermittelt. Wir übermitteln dabei nur die Herkunft der Seite, nicht die vollständige Adresse (<code>Referrer-Policy: strict-origin-when-cross-origin</code>). Rechtsgrundlage ist unser berechtigtes Interesse an einer schnellen und stets aktuellen Darstellung des Bestands (Art. 6 Abs. 1 lit. f DSGVO). Weitere Informationen: <a href="https://www.ebay.de/help/policies/member-behaviour-policies/datenschutzerklrung?id=4260" target="_blank" rel="noreferrer">Datenschutzerklärung von eBay</a>.</p>
      ...
      <p><strong>Mit Kundenkonto geht beides ohne Umweg über uns:</strong> Unter <a href="/account">Konto</a> können Sie alle zu Ihrem Konto gespeicherten Daten als Datei herunterladen und Ihr Konto selbst löschen. Die Löschung entfernt Anfragen, Preisvorschläge und Kartenangebote samt hochgeladener Bilder sowie Ihre Anmeldung. <strong>Bestellungen bleiben als Rechnungsbelege gespeichert</strong> — dazu verpflichten uns die handels- und steuerrechtlichen Aufbewahrungsfristen (Art. 17 Abs. 3 lit. b DSGVO); die Verknüpfung zu Ihrem Konto wird aufgehoben.</p>
      <p><strong>Kartenangebote aus dem Ankauf</strong> löschen wir mitsamt den hochgeladenen Bildern automatisch <strong>90 Tage</strong> nachdem der Vorgang abgeschlossen wurde, also abgelehnt oder beendet ist. Führt ein Angebot zu einem Ankauf, gelten für die daraus entstehenden Kauf- und Rechnungsdaten die gesetzlichen Aufbewahrungsfristen; diese Daten bleiben entsprechend länger gespeichert.</p>
      ...
      <p>Wir setzen derzeit keine nicht erforderlichen Analyse-, Werbe- oder Resend-Trackingfunktionen ein. Falls sich dies ändert, werden die erforderlichen Informationen und gegebenenfalls eine Einwilligungslösung ergänzt. Unabhängig davon werden Kartenbilder direkt von eBay geladen; was dabei übertragen wird, steht in Abschnitt 7.</p>
      <p className="form-feedback">Arbeitsentwurf: Anbieter- und Speicherortangaben sowie Aufbewahrungsfristen sollten vor dem Verkaufsstart anhand der aktuellen Verträge und Anbieterunterlagen rechtlich geprüft werden. Das gilt besonders für die Abschnitte 7 (Einbindung der eBay-Bildserver) und 9 (Löschfrist für Kartenangebote).</p>
    </article>
  </main>;
}
