...
export default function DatenschutzPage() {
  ...
  return <main className="account-page">
    ...
    <article className="account-card legal-page">
      ...
      <p>{t("Wir zählen die Besuche unserer eigenen Seiten, um zu sehen, welche Bereiche des Shops genutzt werden. Damit dieselbe Person nicht mehrfach gezählt wird, bilden wir aus Ihrer IP-Adresse einen nicht umkehrbaren Prüfwert (SHA-256). Dabei geht ein geheimer Zusatzwert ein, der täglich eine andere Wirkung hat und niemals gespeichert wird. Ihre IP-Adresse selbst wird nicht gespeichert, und der Prüfwert lässt sich ohne den geheimen Zusatzwert keiner Adresse zuordnen; mit dem Datumswechsel passt er zu keiner Adresse mehr. Die Prüfwerte werden nach einem Tag gelöscht, die Zählerstände nach 90 Tagen. Es werden keine Cookies gesetzt, keine Profile gebildet und keine Daten an Dritte übermittelt. Rechtsgrundlage ist unser berechtigtes Interesse an einer bedarfsgerechten Gestaltung des Shops (Art. 6 Abs. 1 lit. f DSGVO).")}</p>
